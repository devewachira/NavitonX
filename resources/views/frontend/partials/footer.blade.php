<footer class="page-footer lime-theme-footer">
    <div class="container">
        <div class="row">
            <div class="col m4 s12">
                ...
                @else
                    <p class="grey-text text-lighten-4">At RealEstate, we connect buyers, sellers, and renters with trusted property listings across prime locations. Our mission is to make home discovery simple, reliable, and tailored to your lifestyle.</p>
                @endif
            </div>
    ...
    <div class="footer-copyright">
        <div class="container">
            ...
            @else
                © {{ date('Y') }} Real Estate Website Laravel - Developed Nativon
            @endif
