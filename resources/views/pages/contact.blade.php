                ...
                <div class="col s12 m8">
                    <div class="contact-content">
                        ...
                        <form id="contact-us" action="" method="POST">
                            @csrf
                            <input type="hidden" name="mailto" value="{{ $contactsettings[0]['email'] ?? 'devwachirasoftware@gmail.com' }}">
                ...
                <div class="col s12 m4">
                    <div class="contact-sidebar">
                        <div class="m-t-30">
                            ...
                            @else
                                <h6 class="bold m-l-40">+254743573360</h6>
                            @endif
                        </div>
                        <div class="m-t-30">
                            ...
                            @else
                                <h6 class="bold m-l-40">devwachirasoftware@gmail.com</h6>
                            @endif
                        </div>
                        <div class="m-t-30">
                            ...
                            @else
                                <h6 class="bold m-l-40">City Center, Nairobi, Kenya</h6>
                            @endif
                        </div>
                    </div>
                </div>
